...
- [x] **T-5.1** — Apply 00013_audit_log_table.sql
...
- [x] **T-5.2** — Apply 00014_audit_log_triggers.sql
...
- [x] **T-5.3** — Apply 00015_usuarios_rol_extensions.sql
...
- [x] **T-5.4** — Deploy crear-vendedor Edge Function
