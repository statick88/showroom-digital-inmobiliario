# Vendedor Management DB Specification

## Purpose

Specification for `usuarios_rol` table extensions: `proyecto_id` (FK to proyectos), `dni` (unique per proyecto), and updates to `crear-vendedor` Edge Function.
...
*Promoted from delta spec: openspec/changes/admin-vendedor-audit/specs/vendedor-management-db/spec.md*
*Archive: openspec/changes/archive/2026-06-06-admin-vendedor-audit/archive-report.md*