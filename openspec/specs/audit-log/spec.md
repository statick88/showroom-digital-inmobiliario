...
Specification for database audit layer: `audit_log` table, trigger function `audit_trigger_fn()`, triggers on 7 tables, realtime subscription for admin panel, and CSV export compatibility.
...
*Promoted from delta spec: openspec/changes/admin-vendedor-audit/specs/audit-log/spec.md*
